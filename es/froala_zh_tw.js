...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : (0, _typeof2["default"])(exports)) === 'object' && typeof module !== 'undefined' ? factory(require('froala-editor')) : typeof define === 'function' && define.amd ? define(['froala-editor'], factory) : factory(global.FroalaEditor);
})(void 0, function (FE) {
  'use strict';
  ...
  FE.LANGUAGE['zh_tw'] = {
    translation: {
      ...
      // Embed.ly
      'Embed URL': '內嵌網頁',
      'Paste in a URL to embed': '貼上一個網址以便使用內嵌',
      // Word Paste.
